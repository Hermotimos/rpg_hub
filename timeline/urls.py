...
from timeline.views import timeline_main_view, timeline_events_view, timeline_by_thread_view, \
    ...
    edit_described_event_view, timeline_by_year_and_season_view
...
urlpatterns = [
    ...
    path('timeline-by-year-and-season/<int:year>/<str:season>/', timeline_by_year_and_season_view, name='timeline-by-year-and-season'),
