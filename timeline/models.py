...
class Event(models.Model):
    ...
    participants = models.ManyToManyField(to=Profile, related_name='events_participated', blank=True)
    informed = models.ManyToManyField(to=Profile, related_name='events_informed', blank=True)
