# Generated by Django 3.1 on 2021-10-22 17:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_profiles', models.ManyToManyField(blank=True, limit_choices_to=models.Q(status='player'), related_name='allowed_synergies', to='users.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=4000, null=True)),
                ('sorting_name', models.CharField(blank=True, max_length=250, null=True)),
                ('allowed_profiles', models.ManyToManyField(blank=True, limit_choices_to=models.Q(status='player'), related_name='allowed_elite_classes', to='users.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sorting_name', models.CharField(blank=True, max_length=250, null=True)),
                ('allowed_profiles', models.ManyToManyField(blank=True, limit_choices_to=models.Q(status='player'), related_name='allowed_elite_klasses', to='users.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sorting_name', models.CharField(blank=True, max_length=250, null=True)),
                ('allowed_profiles', models.ManyToManyField(blank=True, limit_choices_to=models.Q(status='player'), related_name='allowed_klasses', to='users.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_profiles', models.ManyToManyField(blank=True, limit_choices_to=models.Q(status='player'), related_name='allowed_plates', to='users.Profile')),
                ('picture_sets', models.ManyToManyField(blank=True, related_name='plates', to='imaginarion.PictureSet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.DecimalField(decimal_places=1, max_digits=10)),
                ('sorting_number', models.DecimalField(decimal_places=2, max_digits=3)),
                ('allowed_profiles', models.ManyToManyField(blank=True, limit_choices_to=models.Q(status='player'), related_name='allowed_shields', to='users.Profile')),
                ('picture_sets', models.ManyToManyField(blank=True, related_name='shields', to='imaginarion.PictureSet')),
            ],
            options={
                'ordering': ['sorting_number'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sorting_name', models.CharField(blank=True, max_length=250, null=True)),
                ('allowed_profiles', models.ManyToManyField(blank=True, limit_choices_to=models.Q(status='player'), related_name='allowed_weapons', to='users.Profile')),
                ('weapon_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='weapons', to='rules.weapontype')),
                ('picture_sets', models.ManyToManyField(blank=True, related_name='weapons', to='imaginarion.PictureSet')),
            ],
            options={
                'ordering': ['sorting_name'],
            },
