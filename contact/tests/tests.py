...
class DemandsDeleteTest(TestCase):
    def setUp(self):
        ...
        self.url = reverse('contact:demands-delete', kwargs={'demand_id': 1})
...
class DemandsModifyTest(TestCase):
    def setUp(self):
        ...
        self.user2 = User.objects.create_user(username='user2', password='pass1111')
        Demand.objects.create(id=1, author=self.user1, addressee=self.user2, text='Demand1')
        self.url = reverse('contact:demands-modify', kwargs={'demand_id': 1})
...
class DemandsDetailTest(TestCase):
    def setUp(self):
        ...
        Demand.objects.create(id=1, author=self.user1, addressee=self.user2, text='Demand1')
        self.url = reverse('contact:demands-detail', kwargs={'demand_id': 1})
...
class MarkDoneTest(TestCase):
    def setUp(self):
        ...
        self.user3 = User.objects.create_user(username='user3', password='pass1111')
        Demand.objects.create(id=1, author=self.user1, addressee=self.user2, text='Demand1')
        self.url = reverse('contact:done', kwargs={'demand_id': 1})
...
class PlansDeleteTest(TestCase):
    def setUp(self):
        self.user1 = User.objects.create_user(username='user1', password='pass1111')
        self.user2 = User.objects.create_user(username='user2', password='pass1111')
        Plan.objects.create(id=1, author=self.user1)
        self.url = reverse('contact:plans-delete', kwargs={'plan_id': 1})
    ...
    def test_404(self):
        self.client.force_login(self.user1)
        url = reverse('contact:plans-delete', kwargs={'plan_id': 999})
        response = self.client.get(url)
        self.assertEquals(response.status_code, 404)
    ...
    def test_url_resolves_view(self):
        view = resolve('/contact/plans/delete:1/')
...
class PlansModifyTest(TestCase):
    def setUp(self):
        ...
        self.user2 = User.objects.create_user(username='user2', password='pass1111')
        Plan.objects.create(id=1, author=self.user1)
        self.url = reverse('contact:plans-modify', kwargs={'plan_id': 1})
    ...
    def test_404(self):
        self.client.force_login(self.user1)
        url = reverse('contact:plans-modify', kwargs={'plan_id': 999})
        response = self.client.get(url)
        self.assertEquals(response.status_code, 404)
    ...
    def test_url_resolves_view(self):
        view = resolve('/contact/plans/modify:1/')
