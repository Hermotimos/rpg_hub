...
from forum.views import forum_view, create_board_view, create_topic_view, posts_in_topic_view, add_allowed_profiles_view
...
urlpatterns = [
    ...
    path('<slug:board_slug>/<slug:topic_slug>/', posts_in_topic_view, name='topic'),
