...
class SurveyOptionDeleteTest(TestCase):
    def setUp(self):
        ...
        self.url = reverse('news:survey-option-delete', kwargs={'survey_id': self.survey1.id,
    ...
    def test_get(self):
        # no template generated by survey_option_delete_view()
        pass

    def test_url_resolves_view(self):
        view = resolve(f'/news/survey-detail:{self.survey1.id}/survey-option:{self.survey1.id}/delete')
        self.assertEquals(view.func, views.survey_option_delete_view)
