...
from news.models import Survey
from news.forms import CreateSurveyForm
...
class SurveyCreateTest(TestCase):
    def setUp(self):
        ...
        self.url = reverse('news:survey-create')
    ...
    def test_url_resolves_view(self):
        view = resolve('/news/survey-create/')
        self.assertEquals(view.func, views.survey_create_view)
    ...
    def test_contains_form(self):
        ...
        self.assertIsInstance(form, CreateSurveyForm)
