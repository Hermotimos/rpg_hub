...
#     e_chrono.locations.add(Location.objects.get(name='Hyllemath'))
#     e_chrono.save()
#
#     # Create ERA
...
#     e_era.locations.add(Location.objects.get(name='Hyllemath'))
#     e_era.save()
#
#     # Create PERIOD
...
#     e_period.locations.add(Location.objects.get(name='Hyllemath'))
#     e_period.save()
