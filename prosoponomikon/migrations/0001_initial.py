    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('knows_if_dead', models.BooleanField(default=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_2', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cognomen', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('acquaintances', models.ManyToManyField(blank=True, related_name='acquaintaned_to', through='prosoponomikon.Acquaintanceship', to='prosoponomikon.character')),
                ...
                ('frequented_locations', models.ManyToManyField(blank=True, related_name='characters', to='toponomikon.location')),
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.profile')),
                ('subprofessions', models.ManyToManyField(blank=True, related_name='characters', to='rules.subprofession')),
            ],
            options={
